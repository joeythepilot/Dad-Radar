...
assert.match(html, /dad-radar-browser\.js\?v=scheduled-trip-count-1/, "The main display loads the generated browser bundle.");
...
assert.match(html, /north-america-caribbean-vintage\.svg\?v=antique-chart-2/, "The sharpened map artwork remains wired into the display.");
