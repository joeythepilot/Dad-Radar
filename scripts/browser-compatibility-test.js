...
assert.match(html, /dad-radar-browser\.js\?v=weather-detail-1/, "The main display loads the generated browser bundle.");
...
assert.match(html, /north-america-caribbean-vintage\.svg\?v=great-lakes-8/, "The proven map artwork remains wired into the display.");
