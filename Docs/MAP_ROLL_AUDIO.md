...
The canonical source file is `assets/audio/dadradar-map-roll-v3-gearmotor.mp3` (a delivery encoding of the approved WAV used for broad browser compatibility, including older Safari).
