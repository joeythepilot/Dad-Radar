...
- The resize-centering proof measures visible text in screen pixels rather than treating an SVG design unit as a display pixel. It retains the exact center anchor and one-pixel visible tolerance across platform fonts.
